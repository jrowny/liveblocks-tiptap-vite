...
export function Toolbar({ editor }: Props) {
  ...
  return (
    <div className="flex gap-1.5">
      ...
      <button className="flex items-center justify-center cursor-pointer rounded-md h-8 w-24 bg-white text-gray-800 border-none shadow-md hover:text-gray-900 hover:shadow-lg focus:outline-offset-2 active:shadow-sm data-[active=is-active]:bg-gray-300"
